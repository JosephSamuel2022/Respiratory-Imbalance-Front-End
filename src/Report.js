...
const Report = () => {
	...
	// Function to get the appropriate class based on the result
	const getResultClass = (result) => {
		if (result === "Chronic") {
			return "result-chronic";
	...
	return (
		<div className='report-container'>
			...
			<h2 className='report-heading'>TEST REPORT</h2>
			...
			<div className='report-image-container'>
				{image && <img src={image} alt='My Plot1' className='report-image' />}
				{image2 && <img src={image2} alt='My Plot2' className='report-image' />}
			...
			<div className='result-container'>
				<p className={`result-heading`}>RESPIRATORY IMBALANCE</p>
				<p className={`result-text ${getResultClass(result)}`}>
